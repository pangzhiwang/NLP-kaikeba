...
def parse_data(train_path, test_path):
    ...
    train_x.to_csv('./datasets/train_set.seg_x.txt', index=None, header=False)
    train_y.to_csv('./datasets/train_set.seg_y.txt', index=None, header=False)
    test_x.to_csv('./datasets/test_set.seg_x.txt', index=None, header=False)
...
if __name__ == '__main__':
    ...
    parse_data('./datasets/AutoMaster_TrainSet.csv','./datasets/AutoMaster_TrainSet.csv')
